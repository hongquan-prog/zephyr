...
The Waveshare ESP32-P4-WIFI6-Dev-Kit is a multimedia development board built around the
ESP32-P4 SoC. It stacks 32 MB of PSRAM and connects a 16 MB NOR flash, exposes
...
routes the Zephyr console to UART0 (GPIO37/38), which is wired to the
...
.. zephyr-app-commands::
   ...
   :board: esp32p4_wifi6_dev_kit/esp32p4/hpcore
   :goals: build flash
   :compact:
...
The LP core target (``esp32p4_wifi6_dev_kit/esp32p4/lpcore``) is also available.
...
.. _`Waveshare ESP32-P4-WIFI6-Dev-Kit Wiki`: https://www.waveshare.com/wiki/ESP32-P4-WIFI6-Dev-Kit
.. _`Waveshare ESP32-P4-WIFI6-Dev-Kit Schematic`: https://files.waveshare.com/wiki/ESP32-P4-WIFI6-Dev-Kit/ESP32-P4-WIFI6-Dev-Kit-datasheet.pdf
